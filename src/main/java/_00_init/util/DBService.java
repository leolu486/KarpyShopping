...
public class DBService {
	...
	private static final String DBURL_SQLServer = "jdbc:sqlserver://" + host + ":1433;databaseName=FinalProject";
	public static final String USERID_SQLServer = "sa";
	public static final String PSWD_SQLServer = "passw0rd";

	private static final String DBURL_MySQL = "jdbc:mysql://" + host
			+ "/finalproject?useUnicode=yes&characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Taipei";
