			...
			<div class="all_cntnt">
					...
					<aside class="single-sidebar">
						...
						<div class="my_account_areadiv" style="margin-top: 40px;">
							<ul>
								...
								<li><a
									href="<spring:url value='/cancelHistory?mId=${memberLoginOK.mId}' />">退訂/退款查詢</a></li>
								<!-- <li><a href="#">換貨/查詢</a></li> -->
								<li><a
									href="<spring:url value='/queryOrderItemsHistory?mId=${memberLoginOK.mId }' />">買過商品查詢</a></li>
							</ul>
						</div>
				...
				<div style="margin-left: 80px">
					...
					<aside class="single-sidebar">
						...
						<div class="my_account_areadiv" style="margin-top: 40px;">
							<ul>
								<li><a href="receiptDetail">統編管理</a></li>
								<li><a href="receiptDetail">發票載具</a></li>
							</ul>
