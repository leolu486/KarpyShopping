...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- meanmenu css -->
        <link rel="stylesheet" href="<c:url value="/css/meanmenu.min.css" />"type="text/css" />
        <!-- nivo slider css -->
        <link rel="stylesheet" href="<c:url value="/css/nivo-slider.css" />"type="text/css" />
        <link rel="stylesheet" href="<c:url value="/css/preview.css" />" type="text/css" />
        <!-- owl.carousel css -->
        ...
        <!-- modernizr js -->
        <script src="/KarpyShopping/src/main/resources/js/vendor/modernizr-2.8.3.min.js"></script>
    </head>
    <body>
                    ...
                    <div class="row">
                            ...
                            <div class="header_heaft_area">
                                <div class="header_left_all">
                                    <div class="mean_al_dv">
                                        <div class="littele_menu"><a href="#">回首頁<i class="fa fa-caret-down"></i></a></div>
                                        <ul  class="option">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                            <div class="header_right_area">
                                <ul>
                                    <li>
                                        <a class="account" href="#">登入</a>
                                    </li>
                                    <li>
                                        <a class="wishlist" href="#">註冊</a>
                                    </li>
                                    <li>
                                        <a class="Shopping cart" href="#">購物車</a>
                                    </li>
                                    <li>
                                        <a class="Checkout" href="#">查詢訂單</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="header_middle">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="logo_area">   
                                <a href="index1.html"><img src="<c:url value="/images/logo-pic/logo.png" />" alt="image" /></a>
                            </div>
                        </div>
                        <div class="col-md-9">
                            <div class="header_all search_box_area">
                                <form class="new_search" role="search" method="get" action="#">
                                    <input id="mix_search" class="search-field" placeholder="請輸入搜尋資料..." value="" name="s" title="Search for:" type="search">
                                                            ...
                                                            <a class="item_link" href="#">
                                                                ...
                                                                <span class="link_content">
                                                                    <span class="link_text">
                                                                        電腦用品
                                                                        <span class="link_descr">3C/桌機/筆電/電競相關產品 </span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        ...
                                                        <li class="differ_sec_area">
                                                            <a class="item_link" href="#">
                                                                ...
                                                                <span class="link_content">
                                                                    <span class="link_text">
                                                                        手機周邊
                                                                        <span class="link_descr">手機/耳機/蘋果/安卓周邊產品 </span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                            <ul class="another_drop_menu">
                                                                <li class="discrip">
                                                                    <a class="new_link_2 with_icon" href="#" tabindex="1">手機</a>
                                                                    <ul class="new_miup_menu">
                                                                        <li>
                                                                            <ul class="new_mixup_tm">
                                                                                <li class="exact">
                                                                                    <a class=" with_icon" href="#" tabindex="1">蘋果手機</a>
                                                                ...
                                                                <li class="risk">
                                                                    <a class="new_link_2 new_link_3 with_icon" href="#" tabindex="1">Apple周邊產品
                                                                    </a>
                                                                    <ul class="new_miup_menu">
                                                                        <li>
                                                                            <ul class="new_mixup_tm">
                                                        ...
                                                        <li class="differ_sec_area">
                                                            <a class="item_link " href="#">
                                                                ...
                                                                <span class="link_content">
                                                                    <span class="link_text">
                                                                        送禮專區
                                                                        <span class="link_descr">精緻禮品/小資禮品/最佳禮物</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                            <ul class="another_drop_menu">
                                                                ...
                                                                <li class="discrip"><a class="new_link_2 new_link_4 with_icon" href="#" tabindex="1">
                                                                    精緻小禮品</a>
                                                                </li>
                                                                <li class="discrip">
                                                                    <a class="new_link_2 new_link_4 with_icon" href="#" tabindex="1">
                                                        ...
                                                        <li>
                                                            <a class="item_link item_link_2" href="#">
                                                                ...
                                                                <span class="link_content">
                                                                    <span class="link_text">
                                                                        男士精品區
                                                                        <span class="link_descr">精品名錶/皮夾/包/皮帶</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="item_link item_link_2" href="#">
                                                                ...
                                                                <span class="link_content">
                                                                    <span class="link_text">
                                                                        女士精品區
                                                                        <span class="link_descr">名牌名包/皮夾/手飾/項鍊/福利品</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="item_link item_link_2" href="#">
                                                                ...
                                                                <span class="link_content">
                                                                    <span class="link_text">
                                                                        NYKD54
                                                                        <span class="link_descr">EEIT10804陳同學推薦專區</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        <li class="cost-menu">
                                                            <a class="item_link item_link_2" href="#">
                                                                ...
                                                                <span class="link_content">
                                                                    <span class="link_text">
                                                                        LEO
                                                                        <span class="link_descr">您今天LEO了嗎?</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                    ...
                    <div class="col-md-12">
                        <div class="bend niceties preview-2">
                            <div id="ensign-nivoslider" class="slides">
                                ...
                                <img  alt="" title="#slider-caption-1" src="<c:url value="/images/slider/xrlogo.png"  />"
                                
                                <img  alt="" title="#slider-caption-2" src="<c:url value="/images/slider/dyson.png" />"
                            </div>
                            <!-- direction 1 -->
                            <div id="slider-caption-1" class="t-cn slider-direction slider-one">
                                ...
                                <div class="tld-f2">
                                    <div class="layer-1-6 animated zoomIn">
                                        <img src="img/slider/IPHONEXR.png" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- direction 2 -->
                            <div id="slider-caption-2" class="slider-direction slider-two">
                                ...
                                <div class="sld-fr">
                                    <div class="layer-2-6 animated zoomIn">
                                        <img src="img/slider/dyson.logo.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <li>
                                <a class="facebook" target="_blank" href="#facebook">
                                    <span>
                                        ...
                                        <span class="social-text">追蹤 Facebook</span>
                                    </span>
                                </a>
                            </li>
                            <!-- <li>
                            ...
                            <li>
                                <a class="youtube" target="_blank" href="#youtube">
                                    <span>
                                        ...
                                        <span class="social-text">訂閱 Youtube</span>
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a class="pinterest" target="_blank" href="#">
                                    <span>
                                        ...
                                        <span class="social-text">追蹤 IG</span>
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a class="mail-to" target="_blank" href="mailto:moghost520@gmail.com">
                                    <span>
                                        <i class="fa fa-envelope-o"></i>
                                        <span class="social-text">寄信給卡痞</span>
                                    </span>
                                </a>
                            </li>
                        </ul>
                                ...
                                <div class="whole_product indicator-brand">
                                    <div class="col-md-12">
                                        <div class="all-pros animated fadeInUp">
                                            ...
                                            <div class="product-action" data-toggle="modal" data-target="#myModal">
                                                <button type="button" class="btn btn-info btn-lg quickview" data-toggle="tooltip" title="Quickview">點我放大</button>   
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="all-pros all-pros-4 animated fadeInUp">
                                            ...
                                            <div class="product-action" data-toggle="modal" data-target="#myModal">
                                                <button type="button" class="btn btn-info btn-lg quickview" data-toggle="tooltip" title="View">點我放大</button>   
                                            </div>
                                            <div class="product_content">
                                                <div class="usal_pro">
                                                    <div class="product_name_2">
                                ...
                                <div class="new_cosmatic indicator-brand indicator-brand-2">
                                    ...
                                    <div class="col-md-12">
                                        <div class="all-pros all-pros-8 animated fadeInUp">
                                            ...
                                            <div class="product-action" data-toggle="modal" data-target="#myModal">
                                                <button type="button" class="btn btn-info btn-lg quickview" data-toggle="tooltip" title="Quickview"> View</button>   
                                            </div>
                                            <div class="product_content">
                                                <div class="usal_pro usal_pro_eb">
                                                    <div class="product_name_2">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="plus_pic">
                            <div class="pix_new">
                                <a href="#">
                                <img src="img/differ-pic/1.jpg" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="dxpt_area">
                                    <div class="news_right">
                                        ...
                                        <ul class="social-icons">
                                            <li>
                                                <a class="facebook social-icon" href="#" title="" target="_blank" data-toggle="tooltip" data-original-title="Facebook">
                                                <i class="fa fa-facebook"></i>
                                                </a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a class="google-plus social-icon" href="#" title="" target="_blank" data-toggle="tooltip" data-original-title="Google">
                                                <i class="fa fa-google"></i>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="youtube social-icon" href="#" title="" target="_blank" data-toggle="tooltip" data-original-title="Youtube">
                                                <i class="fa fa-youtube"></i>
                                                </a>
                                            </li>
                                            <li>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="widget-copyright text-center">
                    ...
                    要您前往ATM進行操作與轉帳!不應在卡痞以外的地方輸入卡痞的帳號密碼，以免影響您的權益。
                </div>
            </div>
        </div>
        ...
        <script src="<c:url value="/js/vendor/jquery-1.12.0.min.js" />"></script>
        <!-- bootstrap js -->
        
        <script  src="<c:url value="/js/vendor/bootstrap.min.js" />"</script>
        <!-- nivo slider js -->
        <script  src="<c:url value="/js/jquery.nivo.slider.js" />"type="text/javascript"></script>
        <script  src="<c:url value="/js/home.js" />"type="text/javascript"></script>
       
        <!-- owl.carousel js -->
        <script  src="<c:url value="/js/owl.carousel.min.js"/>"type="text/javascript"></script>
       
        <!-- meanmenu js -->
        <script src="/KarpyShopping/src/main/webapp/WEB-INF/views/js/jquery.meanmenu.js"></script>
        <!-- jquery-ui js -->
        <script src="/KarpyShopping/src/main/webapp/WEB-INF/views/js/jquery-ui.min.js"></script>
        <!-- easing js -->
        <script src="/KarpyShopping/src/main/webapp/WEB-INF/views/js/jquery.easing.1.3.js"></script>
        <!-- mixitup js -->
        <script src="/KarpyShopping/src/main/webapp/WEB-INF/views/js/jquery.mixitup.min.js"></script>
        <!-- jquery.countdown js -->
        <script src="/KarpyShopping/src/main/webapp/WEB-INF/views/js/jquery.countdown.min.js"></script>
        <!-- wow js -->
        <script src="/KarpyShopping/src/main/webapp/WEB-INF/views/js/wow.min.js"></script>
        <!-- popup js -->
        <script src="/KarpyShopping/src/main/webapp/WEB-INF/views/js/jquery.magnific-popup.min.js"></script> 
        <!-- plugins js -->
        <script src="/KarpyShopping/src/main/webapp/WEB-INF/views/js/plugins.js"></script>
        <!-- main js -->
        <script src="/KarpyShopping/src/main/webapp/WEB-INF/views/js/main.js"></script>
    </body>
</html>
