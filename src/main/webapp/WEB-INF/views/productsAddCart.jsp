...
<jsp:useBean id="member" class="com.web.store.model.MemberBean" scope="session" > 
   ...
   <jsp:setProperty name="member" property="name" value="kitty" />
   <jsp:setProperty name="member" property="tel" value="13245689" />
   <jsp:setProperty name="member" property="addr" value="taipei" />
</jsp:useBean>
<html>
<head>
<meta charset="UTF-8">
