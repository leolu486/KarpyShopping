...
<body class="flat-blue sidebar-collapse">
	...
	<div class="content-container wrap">
		...
		<div class="col-xs-12">
                    <div class="panel panel-warning" style="overflow:auto;height:700px;text-align:center">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="display:inline-block;">會員清單</h3>
                        ...
                        <table class="table table-striped" style="">
                            ...
                            <!-- foreach start -->
                                <tr style="height:80px;">
                                    ...
                                    <td style="vertical-align: middle;"><fmt:formatDate value="${member.birthday}" pattern="yyyy/MM/dd"/></td>
