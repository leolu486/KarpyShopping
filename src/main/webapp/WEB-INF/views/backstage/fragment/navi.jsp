            ...
            <div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">${LoginOK.name} <span class="caret"></span></a>
                            <ul class="dropdown-menu user-info">
                                <li class="dropdown-title-bar">
                                    <img src="<c:url value='/images/default-img/default_member_image.jpg'/>" class="profile-img">
                                </li>
                                <li>
                                    <div class="navbar-login">
                                        ...
                                        <div class="btn-group margin-bottom-2x" role="group">
                                            <a href="managerLogout"><button type="button" class="btn btn-default"><i class="fa fa-sign-out"></i> Logout</button></a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
